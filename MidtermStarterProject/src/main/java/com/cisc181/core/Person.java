...
public abstract class Person {
	...
	/**
	public void PhoneNumber() throws PersonException{
	...
	**/
	...
	public int PrintAge() throws PersonException{
		...
		Calendar TooOld    = Calendar.getInstance();
		
		TooOld.get(today.get(Calendar.YEAR)- 100);
		int age = 0;
		...
		if(birthDate.before(TooOld)){
			throw new PersonException("You are far too old, the age must be wrong.");
		}
